...
const getChannelDetails = asyncHandler(async (req, res) =>{
  ...
  if(!userName?.trim()){
    throw new ApiError(413, "Invalid request for viewing someone's channel")
  }
  ...
  if(!chanel.length){
    throw new ApiError(412, "Chanel doesnot found")
  }

  return res
  .status(200)
  .json(
    new ApiResponse(200, chanel, "Chanel is found successfully")
  )
})
...
export {registerUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, updateUserName, updateAvatar, updateCoverImage, getChannelDetails, getWatchHistory}